    ...
    <div class="card card-xxl-stretch-50 mb-5 mb-xl-8" style="height: 90%; pointer-events: none;">
        <div class="w-full h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6" style="height: 750px; pointer-events: auto;">
            ...
            <div class="col-xxl-4">
                ...
                <div class=" h-auto card card-xxl-stretch-50 mb-5 mb-xl-8">
                    <div class="w-full h-auto bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                        ...
                        <div class="py-6 flex justify-center items-center">
                            <div id="pie-chart" style="width: 200px; height: auto"></div>
                        </div>
                    </div>
                </div>
                <!--end::Mixed Widget 7-->
...
<script>
    ...
    if (!window.areaChart) {
        window.areaChart = new ApexCharts(document.getElementById("area-chart"), options);
