...
<body style="font-family: Arial, sans-serif; color: #1a1a1a; margin: 0; padding: 0; background-color: #f5f5f5;">
    <div style="width: 100%; max-width: 700px; margin: 0 auto; background: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <div style="background-color: #1a237e; padding: 20px; text-align: center;">
            ...
            <h1 style="font-size: 20px; color: #ffffff; margin: 10px 0 0; text-transform: uppercase;">Xác nhận Đặt Cọc Thành Công</h1>
        </div>
        ...
        <div style="padding: 20px;">
            ...
            <div style="font-size: 14px; line-height: 1.5; margin-bottom: 20px; color: #333333;">
                Trân trọng cảm ơn Quý khách đã tin tưởng và lựa chọn dịch vụ thuê xe tại <strong>SuperWeb Auto Showroom</strong>. 
                Chúng tôi xin xác nhận thông tin đặt cọc của Quý khách như sau:
            </div>
            ...
            <div style="background-color: #f8f9fc; padding: 15px; border: 1px solid #e0e0e0; border-radius: 8px; margin-bottom: 20px;">
                ...
                <div style="margin-bottom: 10px; font-size: 14px;">
                    ...
                    <span style="font-weight: bold; color: #1a237e;">{{ number_format($deposit_amount, 0, ',', '.') }} VNĐ</span>
                </div>
            ...
            <div style="background-color: #fff8e1; padding: 15px; border-left: 4px solid #ffd54f; font-size: 14px; margin-bottom: 20px;">
                <strong>Lưu ý quan trọng:</strong> Để hoàn tất quy trình thuê xe, Quý khách vui lòng thanh toán số tiền còn lại khi đến nhận xe tại showroom của chúng tôi.
            </div>
