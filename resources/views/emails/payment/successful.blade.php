...
<body style="font-family: Arial, sans-serif; color: #1a1a1a; margin: 0; padding: 0; background-color: #f5f5f5;">
    <div style="width: 100%; max-width: 700px; margin: 0 auto; background: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
        <div style="background-color: #1a237e; padding: 20px; text-align: center;">
            ...
            <h1 style="font-size: 20px; color: #ffffff; margin: 10px 0 0; text-transform: uppercase;">Xác nhận Thanh Toán Gia Hạn Thành Công</h1>
        </div>
        ...
        <div style="padding: 20px;">
            ...
            <div style="font-size: 14px; line-height: 1.5; margin-bottom: 20px; color: #333333;">
                Chúng tôi xin xác nhận thông tin thanh toán gia hạn của Quý khách như sau:
            </div>
            ...
            <div style="background-color: #f8f9fc; padding: 15px; border: 1px solid #e0e0e0; border-radius: 8px; margin-bottom: 20px;">
                ...
                <div style="margin-bottom: 10px; font-size: 14px;">
                    <span style="color: #4a4a4a; font-weight: bold; display: inline-block; width: 150px;">Mã Hóa Đơn:</span>
                    <span style="font-weight: bold; color: #1a237e;">{{ $receipt_id }}</span>
                </div>
                <div style="margin-bottom: 10px; font-size: 14px;">
                    <span style="color: #4a4a4a; font-weight: bold; display: inline-block; width: 150px;">Ngày Bắt Đầu:</span>
                    <span style="font-weight: bold; color: #1a237e;">{{ $start_date }}</span>
                </div>
                <div style="margin-bottom: 10px; font-size: 14px;">
                    <span style="color: #4a4a4a; font-weight: bold; display: inline-block; width: 150px;">Ngày Kết Thúc:</span>
                    <span style="font-weight: bold; color: #1a237e;">{{ $end_date }}</span>
                </div>
                <div style="margin-bottom: 10px; font-size: 14px;">
                    <span style="color: #4a4a4a; font-weight: bold; display: inline-block; width: 150px;">Tổng Chi Phí:</span>
                    <span style="font-weight: bold; color: #1a237e;">{{ number_format($total_cost, 0, ',', '.') }} VND</span>
                </div>                
            </div>
