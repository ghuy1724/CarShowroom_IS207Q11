...
<div class="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
    ...
    <div class="flex justify-center">
        ...
        <a href="https://x.com/25_join89592" class="me-6 [&>svg]:h-4 [&>svg]:w-4 ">
        ...
        <a href="https://github.com/phuy1125" class="[&>svg]:h-4 [&>svg]:w-4">
    ...
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            ...
            <p class="mb-4 flex items-center justify-center md:justify-start">
                ...
                24 NO. 7 STREET, QUARTER 4, BINH CHIEU WARD, THU DUC CITY
            </p>
            <p class="mb-4 flex items-center justify-center md:justify-start">
                <span class="me-3 [&>svg]:h-5 [&>svg]:w-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
