...
@section('content')
    ...
    <div class="relative min-h-screen py-10" style="background: linear-gradient(135deg, #8eb3f6 0%, #a8d5ff 25%, #d8ecff 50%, #f3f9ff 75%, #ffffff 100%);">
        <!-- Decorative Elements -->
        ...
        <div class="container mx-auto px-4 relative">
            <div class="relative overflow-hidden bg-gradient-to-r from-gray-700 via-gray-600 to-blue-700 shadow-2xl rounded-2xl p-12 mb-10">
