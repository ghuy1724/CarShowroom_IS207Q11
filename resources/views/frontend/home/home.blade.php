...
@section('content')
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <!-- Maintenance Detail -->
            <div class="rounded-lg shadow-lg overflow-hidden">
                <img src="https://pictures.porsche.com/rtt/iris?COSY-EU-100-1711cYLvsi60rFkXqXUnBEgAHYByY9AJ%25OggSPvuB1pkbgI7DMJphteDkrNqLHn45pXnfZYovIS0rhO3RMFYqwhXjbWBbaoD2OFmI1BSCAW%25k4Zo9Zs1l2PY6QzpFCjspAnPKWbiZJyNSWFctBvotwvf8dXF2iqPED6uvpzN9nReRpMo4y7z8LtF%25vUq4ykuWXsOB3iZJyN4vv39h7nw%25Xj4AUP1S6a0LDpUuBLTugatwlg2dEheSY0lILHnH"
            ...
            <!-- Full Detail -->
            <div class="rounded-lg shadow-lg overflow-hidden">
                <img src="https://pictures.porsche.com/rtt/iris?COSY-EU-100-1711coMvsi60AAt5FwcmBEgA4qP8iBUDxPE3LUUEssTugNTb7gKOCl3UBb%25cUzW1TipaIKyGZPm21CS9ctLD6L8T7wG2Epk6a0vDdgBWTJWFk4wq1fx5%253dkF%25vUqjdTuWXsOB3iZJyN4vv39h7nw%25Xjbkdl7FJkOFmjZrgmTB8VuKQbgLk0D0UlS7h%258XsXb1qG"
                ...
                <div class="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                    <div class="relative space-y-8 py-12 p-8">
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                            stroke-linecap="round" stroke-linejoin="round" color="white" style="color:white"
